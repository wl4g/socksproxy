 ...
 * @author Shai Almog
 */
public class SocksProxyStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "SocksProxy";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new SocksProxyStub());
    }
